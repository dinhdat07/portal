...
func ListUsersResultToPB(result *service.ListUsersResult) *adminv1.ListUsersResponse {
	if result == nil {
		return nil
	}
...
func RolesToPB(roles []model.Role) *adminv1.ListRolesResponse {
...
func RoleModelToPB(role *model.Role) *commonv1.Role {
	if role == nil {
		return nil
	}
...
func PermissionsToPB(perms []model.Permission) *adminv1.ListPermissionsResponse {
...
func PermissionModelToPB(perm *model.Permission) *commonv1.Permission {
	if perm == nil {
		return nil
	}
