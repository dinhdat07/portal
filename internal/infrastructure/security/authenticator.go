...
type Authenticator struct {
	manager     service.TokenIssuer
	roleRepo    repository.RoleRepository
	sessionRepo repository.AuthSessionRepository
	revoStore   service.SessionRevocationStore
}

func NewAuthenticator(manager service.TokenIssuer, roleRepo repository.RoleRepository, sessionRepo repository.AuthSessionRepository, revoStore service.SessionRevocationStore) *Authenticator {
