...
func (m *Manager) GenerateAccessToken(input service.GenerateAccessTokenInput) (string, error) {
	now := time.Now()
...
func (m *Manager) Parse(tokenString string) (*service.TokenClaims, error) {
